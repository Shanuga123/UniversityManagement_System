            ...
            <Navbar>
                ...
                <CoursesGrid>
                    <CourseCard style={{ backgroundImage: `url(${ComputerScienceImage})` }}>
                        ...
                        <p>Learn the fundamentals of computer science and programming. Explore algorithms, data structures, and software engineering principles.
    Develop problem-solving skills and gain practical programming experience.</p>
    Explore algorithms, data structures, and software engineering principles.
    Develop problem-solving skills and gain practical programming experience.
                    </CourseCard>
                    <CourseCard style={{ backgroundImage: `url(${ComputerScienceImage})` }}>
