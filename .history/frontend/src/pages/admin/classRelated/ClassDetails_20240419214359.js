...
// import userProfileGif from '../admin/admingif/userProfile.gif'; 
...
const ClassDetailsSection = () => {
    ...
    return (
        ...
        <div style={styles.linearGradientBackground}>
...
const styles = {
        ...
        container: {
            display: 'flex', // Already set for flexbox
            justifyContent: 'center', // Centers horizontally
            alignItems: 'center', // Centers vertically
            height: '100vh',
            background: 'linear-gradient(to right, #4CAF50, #2196F3)', // Remove inline background
        },
        linearGradientBackground: {
          background: 'linear-gradient(to right, #4CAF50, #2196F3)',
          position: ', // Ensure it covers the entire container
          top: 0,
          left: 0,
          right: 0,
          bottom: 0,
