...
https://www.istockphoto.com/photo/on-the-desk-personal-computer-showing-infrastructure-system-control-on-its-display-gm1294339664-388370899
            ...
            <Navbar>
                ...
                <CoursesGrid>
                    <CourseCard style={{ backgroundImage: `url(${ComputerScienceImage})` }}>
                        <h3>Computing</h3>
                        <p>Learn the fundamentals of computer science and programming and Software Engineering </p>
                    ...
                    <CourseCard style={{ backgroundImage: `url(${TechImage})` }}>
                        <h3>Technology</h3>
                        <p>Explore the latest advancements in technology, including programming languages, software development tools</p>
                    </CourseCard>
                    <CourseCard style={{ backgroundImage: `url(${AgriImage})` }}>
                        <h3>Agriculture</h3>
                        <p>Discover the latest innovations in agriculture, from precision farming techniques to sustainable practices and agricultural technologies </p>
