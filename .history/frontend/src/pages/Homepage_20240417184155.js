...
import ComputerScienceImage from '../assets/computing.jpg';
import BusinessAdministrationImage from '../assets/business_administration.jpg';
import PsychologyImage from '../assets/psychology.jpg';
        ...
        <div>
            <Navbar>
                ...
                <CoursesGrid>
                    ...
                    <CourseCard style={{ backgroundImage: `url(${BusinessAdministrationImage})` }}>
                        <h3>Business Administration</h3>
                        <p>Master the principles of management, finance, and marketing.</p>
                    </CourseCard>
                    <CourseCard style={{ backgroundImage: `url(${PsychologyImage})` }}>
                        <h3>Psychology</h3>
