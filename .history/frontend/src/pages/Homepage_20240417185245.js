...
const Homepage = () => {
    ...
    <p>Explore algorithms, data structures, and software engineering principles.</p>
    <p>Develop problem-solving skills and gain practical programming experience.</p>
                    </CourseCard>
                    <CourseCard style={{ backgroundImage: `url(${ComputerScienceImage})` }}>
