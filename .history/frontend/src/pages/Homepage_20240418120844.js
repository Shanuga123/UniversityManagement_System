            ...
            <Navbar>
                ...
                <CoursesGrid>
                    ...
                    <CourseCard style={{ backgroundImage: `url(${TechImage})` }}>
                        <h3>Technology</h3>
                        <p>
Technology courses explore the latest advancements in computing, engineering, and applied sciences, preparing students for careers at the forefront of innovation. </p>
                    </CourseCard>
